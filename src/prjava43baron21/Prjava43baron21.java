...
package prjava43baron21;
import java.awt.*; // using AWT containers and components
import java.awt.event.*; // using AWT events and listener interfaces
// An AWT GUI program inherits the top-level container java.awt.Frame
public class prjava43baron21 extends Frame
...
setTitle("nova finestra prjava43baron21"); // "this" Frame sets title
setSize(450, 100); // "this" Frame sets initial size
setVisible(true); // "this" Frame shows
}
/** The entry main() method */
public static void main(String[] args) {
new prjava43baron21(); // Let the construct do the job
}
/** ActionEvent handler */
@Override
